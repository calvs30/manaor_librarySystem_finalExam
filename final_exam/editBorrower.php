...
<head>
    ...
    <title>Library System - Edit Borrower</title>
    ...
    <div class="app-container">
        ...
        <main class="main-content">
            <div class="page-header">
                ...
                <h1>Edit Borrower Profile Information</h1>
            </div>

            <div class="card" style="max-width: 650px; margin: 0 auto;">
                <h2>Profile Information</h2>
                <?php $user = getBorrowerByID($pdo, $_GET['borrower_id']); ?>
                <form action="core/handleForms.php?borrower_id=<?php echo $_GET['borrower_id']; ?>" method="POST">
                    <p><label>First Name</label><input type="text" name="firstName" value="<?php echo sanitize($user['first_name']); ?>" required></p>
                    <p><label>Last Name</label><input type="text" name="lastName" value="<?php echo sanitize($user['last_name']); ?>" required></p>
                    <p><label>Address Info</label><input type="text" name="homeAddress" value="<?php echo sanitize($user['home_address']); ?>" required></p>
                    <p><label>Contact Data</label><input type="text" name="contactNumber" value="<?php echo sanitize($user['contact_number']); ?>" required></p>
                    
                    <div style="display: flex; gap: 12px; margin-top: 25px;">
                        <input type="submit" name="editBorrowerBtn" value="Save" style="flex: 1;">
